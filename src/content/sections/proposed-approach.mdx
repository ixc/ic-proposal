...
---
import ContentSubHeader from '../../components/ContentSubHeader.astro';

<ContentSubHeader subtitle={frontmatter.headers[0]} />
...
<ContentSubHeader subtitle={frontmatter.headers[1]} />
...
<ContentSubHeader subtitle={frontmatter.headers[2]} />
...
<ContentSubHeader subtitle={frontmatter.headers[3]} />
